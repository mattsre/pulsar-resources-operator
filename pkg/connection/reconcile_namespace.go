...
func (r *PulsarNamespaceReconciler) ReconcileNamespace(ctx context.Context, pulsarAdmin admin.PulsarAdmin,
	...
	params := &admin.NamespaceParams{
		...
		EncryptionRequired:                    namespace.Spec.EncryptionRequired,
		SubscriptionAuthMode:                  namespace.Spec.SubscriptionAuthMode,
		AntiAffinityGroup:                     namespace.Spec.AntiAffinityGroup,
		SchemaAutoUpdateCompatibilityStrategy: namespace.Spec.SchemaAutoUpdateCompatibilityStrategy,
	}
